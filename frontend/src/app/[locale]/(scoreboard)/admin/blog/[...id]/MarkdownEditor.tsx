...
import { BlogListItem } from '@/app/[locale]/(blog)/blog/BlogListItem';
import { GameViewer } from '@/app/[locale]/(blog)/blog/player-spotlight/GameViewer';
    ...
    return (
        <Stack spacing={2}>
            ...
            {mode === 'write' ? (
                ...
                <Box
                    data-testid='markdown-list-preview'
                    sx={{
                        minHeight,
                        px: 2,
                        py: 2,
