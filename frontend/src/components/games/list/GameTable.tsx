...
export default function GameTable({
    ...
    const t = useTranslations('games.table');
    ...
    const gameTableColumns = useMemo<GridColDef<GameInfo>[]>(
        () => [
            {
                field: 'cohort',
                headerName: t('cohort'),
    ...
    }, [freeTierLimited, columns, gameTableColumns]);
