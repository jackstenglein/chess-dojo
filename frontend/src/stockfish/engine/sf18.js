async function Sf_18_Web(moduleArg = {}) {
    var moduleRtn;
    var h = moduleArg,
    ...
    async function ya() {
        ...
        Sa = `${window.location.origin}/static/engine/sf18.wasm`;
        return (function (d) {
        ...
        Sb = (a) => {
            if (0 == F.length) {
                if (h.mainScriptUrlOrBlob) {
                    ...
                    b = new Worker(new URL(`${window.location.origin}/static/engine/sf18.js`), {
                        type: 'module',
                        name: 'em-pthread',
                    });
                F.push(b);
