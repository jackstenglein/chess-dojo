...
test.describe('List Games Page', () => {
    ...
    test('allows searching by player', async ({ page }) => {
        ...
        await waitForNavigation(
            page,
            /\/(en|pseudo)\/games\?type=player&player=JackStenglein&color=either&startDate=&endDate=$/,
        );
    });
    ...
    test('allows searching by eco', async ({ page }) => {
        ...
        await waitForNavigation(
            page,
            /\/(en|pseudo)\/games\?type=opening&eco=B01&startDate=&endDate=$/,
        );
    });
    ...
    test('allows searching current user uploads', async ({ page }) => {
        ...
        await waitForNavigation(page, /\/(en|pseudo)\/games\?type=owner&startDate=&endDate=$/);
    });
