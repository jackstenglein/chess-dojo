...
const (
	...
	// Notifications generated by a game submitted for sensei review
	NotificationType_GameReviewSubmitted NotificationType = "GAME_REVIEW_SUBMITTED"

	// Notifications generated by a user signing up for Game & Profile Review
	NotificationType_GameReviewSignup NotificationType = "GAME_REVIEW_SIGNUP"
	...
	// Notifications generated by a user creating a subscription
	NotificationType_SubscriptionCreated NotificationType = "SUBSCRIPTION_CREATED"
)
...
func SendGameReviewSubmittedEvent(game *Game) error {
	event := struct {
		Type string `json:"type"`
		Game struct {
			Cohort string `json:"cohort"`
		...
		Type: string(NotificationType_GameReviewSubmitted),
		Game: struct {
			Cohort string "json:\"cohort\""
			Id     string "json:\"id\""
		}{
...
func SendGameReviewSignupEvent(username string) error {
	event := struct {
		Type     string `json:"type"`
		Username string `json:"username"`
	}{
		Type:     string(NotificationType_GameReviewSignup),
		Username: username,
	}
	return sendSqsEvent(event)
}
...
func SendSubscriptionCreatedEvent(username string) error {
	e := struct {
		Type     string `json:"type"`
		Username string `json:"username"`
	}{
		Type:     string(NotificationType_SubscriptionCreated),
		Username: username,
	}
	return sendSqsEvent(e)
}
